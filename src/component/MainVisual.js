...
const SLIDE = [
    {
        id: 1,
        content: 
                "01 The world expands along\nthe new pach created",
    ...
    {
        id: 2,
        content: "02 The world expands along the\n new pach created",
        desc: "현대엘리베이터가 만든 새로운 길을 따라 세상은 위로 넓어집니다.",
        link: "https://my.matterport.com/show/?m=yEdf9FWaNav",
        title: "New pach created",
    },
    {
        id: 3,
        content: "03 The world expands\n along the new pach created",
        desc: "현대엘리베이터가 만든 새로운 길을 따라 세상은 위로 넓어집니다.",
        link: "https://my.matterport.com/show/?m=yEdf9FWaNav",
        title: "The world expands",
    },
